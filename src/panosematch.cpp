...
int PanoseMatch::diff(const QString &other) const
{
    ...
    //
    if (attributes[FamilyType] != 0 && attrOther[FamilyType] != 0 && attributes[FamilyType] != attrOther[FamilyType])
        return -1;
    ...
    //
    result += calcdiffm(attributes[Weight], attrOther[Weight], 12);
    result += calcdiffm(attributes[Contrast], attrOther[Contrast], 10);
    result += calcdiffm(attributes[StrokeVariation], attrOther[StrokeVariation], 9);
    //
    ...
    //
    result += calcdiffss(attributes[SerifStyle], attrOther[SerifStyle]);
    result += calcdiffd(attributes[Proportion], attrOther[Proportion]);
    result += calcdiffd(attributes[ArmStyle], attrOther[ArmStyle]);
    result += calcdifflf(attributes[Letterform], attrOther[Letterform]);
    result += calcdiffd(attributes[Midline], attrOther[Midline]);
    result += calcdiffd(attributes[XHeight], attrOther[XHeight]);
    return result;
}
