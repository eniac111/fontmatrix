...
void FontStrings::fillFSftypeMap()
{
    ...
    m_FsType[FontItem::NOT_RESTRICTED] = i18n(
    ...
    m_FsType[FontItem::RESTRICTED] =
        i18n("This font must not be modified, embedded or exchanged in any manner without first obtaining permission of the legal owner.");
    m_FsType[FontItem::PREVIEW_PRINT] = i18n(
    ...
    m_FsType[FontItem::EDIT_EMBED] = i18n(
    ...
    m_FsType[FontItem::NOSUBSET] =
        i18n("This font may not be subsetted prior to embedding. Other embedding restrictions specified in bits 0-3 and 9 also apply.");
    m_FsType[FontItem::BITMAP_ONLY] = i18n(
